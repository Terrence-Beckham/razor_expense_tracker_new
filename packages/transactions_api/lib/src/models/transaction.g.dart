...
const TransactionSchema = CollectionSchema(
  ...
  indexes: {},
  links: {
    r'transactionCategory': LinkSchema(
      id: 4496875711927081263,
...
void _transactionSerialize(
  ...
  writer.writeString(offsets[6], object.subCategory);
...
List<IsarLinkBase<dynamic>> _transactionGetLinks(Transaction object) {
  return [object.transactionCategory];
}

void _transactionAttach(
    IsarCollection<dynamic> col, Id id, Transaction object) {
  object.id = id;
  object.transactionCategory.attach(col,
      col.isar.collection<TransactionCategory>(), r'transactionCategory', id);
}
...
extension TransactionQueryLinks
    on QueryBuilder<Transaction, Transaction, QFilterCondition> {
  QueryBuilder<Transaction, Transaction, QAfterFilterCondition>
      transactionCategory(FilterQuery<TransactionCategory> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'transactionCategory');
    });
  }

  QueryBuilder<Transaction, Transaction, QAfterFilterCondition>
      transactionCategoryIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'transactionCategory', 0, true, 0, true);
    });
  }
}
